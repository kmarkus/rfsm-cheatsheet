...
it is called a \textbf{leaf state}. An active rFSM instance is always
in a leaf-state!
...
more sophisticated transitions, the FSM is \textit{never} in the
connector!
...
the rtp module, see Links), \texttt{rtt.getTime} from RTT-Lua, or for
